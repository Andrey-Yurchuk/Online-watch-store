<header class="masthead" style="background-image: url('/public/images/nature_light_bokeh_pxhere.jpg'); background-color: #fff; margin-bottom: -30px;">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-10 mx-auto">
                <div class="site-heading" style="padding: 90px;">
                    <h1 style="font-size: 65px; padding-top: 35px">Интернет-магазин часов</h1> 
